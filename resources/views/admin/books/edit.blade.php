...
<div style="display: flex; align-items: center; margin-bottom: 1.5rem;">
    ...
    <h2 style="margin: 0; color: #1e293b;">Edit Data Buku: {{ $book->title }}</h2>
</div>
            ...
            <div class="card">
                ...
                <div style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="statement_of_responsibility" class="form-control" style="width: 100%; padding: 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px;" value="{{ old('statement_of_responsibility', $book->statement_of_responsibility) }}">
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="publication_year" class="form-control" style="width: 100%; padding: 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px;" value="{{ old('publication_year', $book->publication_year) }}" placeholder="Contoh: 2023">
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="series_title" class="form-control" style="width: 100%; padding: 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px;" value="{{ old('series_title', $book->series_title) }}">
                    </div>
                    <div style="flex: 1;">
                        <label style="display: block; font-weight: 500; margin-bottom: 0.5rem; color: #475569;">No. Panggil</label>
                        <input type="text" name="call_number" class="form-control" style="width: 100%; padding: 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px;" value="{{ old('call_number', $book->call_number) }}">
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="language" class="form-control" style="width: 100%; padding: 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px;" value="{{ old('language', $book->language) }}" placeholder="Contoh: Indonesia">
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="classification" class="form-control" style="width: 100%; padding: 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px;" value="{{ old('classification', $book->classification) }}">
                    </div>
                    <div style="flex: 1;">
                ...
                <div style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="content_type" class="form-control" style="width: 100%; padding: 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px;" value="{{ old('content_type', $book->content_type) }}">
                    </div>
                    <div style="flex: 1;">
                        <label style="display: block; font-weight: 500; margin-bottom: 0.5rem; color: #475569;">Tipe Media</label>
                        <input type="text" name="media_type" class="form-control" style="width: 100%; padding: 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px;" value="{{ old('media_type', $book->media_type) }}">
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="carrier_type" class="form-control" style="width: 100%; padding: 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px;" value="{{ old('carrier_type', $book->carrier_type) }}">
                    </div>
                    <div style="flex: 1;">
                        <label style="display: block; font-weight: 500; margin-bottom: 0.5rem; color: #475569;">Edisi</label>
                        <input type="text" name="edition" class="form-control" style="width: 100%; padding: 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px;" value="{{ old('edition', $book->edition) }}">
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 1rem;">
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="physical_description" class="form-control" style="width: 100%; padding: 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px;" value="{{ old('physical_description', $book->physical_description) }}" placeholder="Contoh: x, 254 hal, 23cm">
                    </div>
                    <div style="flex: 1;">
                        <label style="display: block; font-weight: 500; margin-bottom: 0.5rem; color: #475569;">Info Detail Spesifik</label>
                        <input type="text" name="specific_detail_info" class="form-control" style="width: 100%; padding: 0.6rem; border: 1px solid #cbd5e1; border-radius: 4px;" value="{{ old('specific_detail_info', $book->specific_detail_info) }}">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    @if($book->cover_image)
                        <div style="margin-bottom: 10px;">
                            <img src="{{ asset('storage/' . $book->cover_image) }}" alt="Cover Buku" style="max-width: 100%; max-height: 200px; border-radius: 4px; border: 1px solid #e2e8f0; display: block; margin: 0 auto;">
                        </div>
                    @endif
                    ...
                    <small style="color: #64748b; margin-top: 5px; display: block;">Biarkan kosong jika tidak ingin mengubah cover.</small>
                </div>

                <div style="margin-bottom: 1.5rem; padding: 1rem; border: 1px solid #e2e8f0; border-radius: 6px; background-color: #f8fafc;">
                    <label style="display: flex; align-items: center; cursor: pointer;">
                        <input type="checkbox" name="is_available" value="1" style="width: 18px; height: 18px; margin-right: 10px;" {{ old('is_available', $book->is_available) ? 'checked' : '' }}>
